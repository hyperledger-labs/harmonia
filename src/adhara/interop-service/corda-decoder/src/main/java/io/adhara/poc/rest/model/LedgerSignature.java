...
public class LedgerSignature {
  private String blockchainId;           // Source ledger identification.
  ...
  private String senderId;               // Sender identification given as foreign account id, e.g. X500 name, or local account id, e.g. BIC.
  private String receiverId;             // Receiver identification given as foreign account id, e.g. X500 name, or local account id, e.g. BIC.
  ...
  private String authBlockchainId;       // Auth ledger identification. Must be a ledger authorized to call performCallFromRemoteChain.

module.exports = function (app, cordaRegisteredFunctionService) {
  ...
  app.get('/:systemId/cordaRegisteredFunctions', async (req, res, next) => {
  ...
  app.post('/:systemId/cordaRegisteredFunctions', async (req, res, next) => {
    /* #swagger.tags = ['CordaRegisteredFunctions']
    ...
    */
    /* #swagger.parameters['parameterHandlers'] = {
         in: 'body',
  ...
  app.delete('/:systemId/cordaRegisteredFunctions', async (req, res, next) => {
    /* #swagger.tags = ['CordaRegisteredFunctions']

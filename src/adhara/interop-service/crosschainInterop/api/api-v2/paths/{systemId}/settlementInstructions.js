module.exports = function (app, settlementInstructionService) {
  ...
  app.get('/:systemId/settlementInstructions', async (req, res, next) => {
  ...
  app.post('/:systemId/settlementInstructions', async (req, res, next) => {
    /* #swagger.tags = ['SettlementInstructions']
  ...
  app.patch('/:systemId/settlementInstructions', async (req, res, next) => {
    /* #swagger.tags = ['SettlementInstructions']
  ...
  app.delete('/:systemId/settlementInstructions', async (req, res, next) => {
    /* #swagger.tags = ['SettlementInstructions']

package com.r3.corda.evmbridge.internal

import com.r3.corda.evmbridge.IERC20
import com.r3.corda.evmbridge.IWeb3
...
/**
 * ~/evm-bridge-workflows testnet setup
 */
abstract class TestNetSetup(
    ...
    private fun networkSetup() {
        ...
        try {
            ...
            aliceAddress = alice.services.evmBridge().signerAddress()
            bobAddress = bob.services.evmBridge().signerAddress()
            charlieAddress = charlie.services.evmBridge().signerAddress()
        } catch (ex: Exception) {
    ...
    private fun mockNetwork() : MockNetwork {
        return MockNetwork(listOf("com.r3.corda.evmbridge"),
            notarySpecs = listOf(

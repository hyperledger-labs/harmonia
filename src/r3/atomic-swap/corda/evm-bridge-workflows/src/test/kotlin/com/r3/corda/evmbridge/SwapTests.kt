...
import com.r3.corda.evmbridge.workflows.Erc20TransferFlow
...
class SwapTests : TestNetSetup() {
    ...
    fun `can successfully unlock using the tx receipt matching the expected event`() {
        ...
        val assetTx = await(bob.startFlow(IssueGenericAssetFlow()))
        ...
        val swapDetails = SwapTransactionDetails(
            ...
            evmAssetContractAddress = goldTokenDeployAddress, // TODO: review, probably not necessary anymore
            approvedCordaValidators = listOf(charlie.toParty()),
            minimumNumberOfEventValidations = 1,
            evmBlockchainId = 1337, // NOTE: temporarily unused

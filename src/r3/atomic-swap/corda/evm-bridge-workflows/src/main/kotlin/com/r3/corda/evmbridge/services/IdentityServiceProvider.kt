...
//        }
    ...
    private class Web3Impl(private val session: Session) : IWeb3 {
        ...
        override fun getTransactionByHash(hash: String) : FlowExternalOperation<com.r3.corda.cno.evmbridge.dto.Transaction> {
...
fun FlowLogic<*>.evmBridge() : EvmBridge {
    return EvmBridge(this)
}

fun ServiceHub.evmBridge() : EvmBridge {
    return EvmBridge(this)
}

...
internal class Connection(private val connectionId: ConnectionId) {
    ...
    fun queueEventLogResponse(address: String): ResponseOperation<com.r3.corda.cno.evmbridge.dto.Log> {
        val future = CompletableFuture<com.r3.corda.cno.evmbridge.dto.Log>()
        ...
        web3j.ethLogFlowable(filter).subscribe { log ->
            eq[address]!!.map { completableEvent ->
                completableEvent.complete(
                    com.r3.corda.cno.evmbridge.dto.Log(
    ...
    fun mapTransaction(tx: Transaction): com.r3.corda.cno.evmbridge.dto.Transaction {
        //val tx = ethTransaction.transaction.orElseThrow { IllegalArgumentException("Null transaction!") }
        return com.r3.corda.cno.evmbridge.dto.Transaction(
            tx.hash,
            tx.nonce,
            tx.blockHash,
            tx.blockNumber,

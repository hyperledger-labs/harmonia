...
* Work-in-progress code that implements the above design is also available in this repo. Start with the [README](https://github.com/hyperledger-labs/harmonia/blob/main/src/r3/atomic-swap/corda/README.md#corda-evm-interop).  
